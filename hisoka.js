...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
            ...
            case 'owner': case 'creator': {
                let vcard = 'BEGIN:VCARD\n' // metadata of the contact card
                    ...
                    + 'TEL;type=CELL;type=VOICE;waid=6281536103144:+62 815-3610-3144\n' // WhatsApp ID + phone number
                    + 'END:VCARD'
...
⭔ ${prefix}group  [option]
⭔ ${prefix}add @user
⭔ ${asep}${prefix}kick${asep}  @user
⭔ ${asep}${prefix}promote${asep}  @user
⭔ ${asep}${prefix}demote${asep}  @user
...
⭔ ${asep}${prefix}chat${asep}  [option]
⭔ ${asep}${prefix}join${asep}  [link]
⭔ ${asep}${prefix}leave${asep}
⭔ ${asep}${prefix}block${asep}  @user
⭔ ${asep}${prefix}unblock${asep}  @user

𝐈𝐬𝐥𝐚𝐦 𝐌𝐞𝐧𝐮

⭔ ${asep}${prefix}jadwalsholat${asep}  daerah
⭔ ${asep}${prefix}alquran${asep}  query
⭔ ${asep}${prefix}kisahnabi${asep}  query
                ...
                const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: 'Kuntul Raksasa',
                                    url: 'www.xnxx.com'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Call Owner',
                                    phoneNumber: '+62 815-3610-3144'
                                }
                            }, {
                                quickReplyButton: {
